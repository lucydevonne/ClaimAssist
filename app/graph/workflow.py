...
from app.agents.risk_agent import analyze_claim_risk
from app.agents.resolution_agent import recommend_claim_resolution
...
def run_claim_workflow(initial_state: ClaimWorkflowState) -> ClaimWorkflowState:
    ...
    4. Run risk analysis agent.
    5. Run resolution recommendation agent.
    ...
    workflow_state = analyze_claim_risk(workflow_state)
    workflow_state = recommend_claim_resolution(workflow_state)
